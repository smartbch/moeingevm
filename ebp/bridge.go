...
// In this file, we define functions in C world and declare functions exported by Go world
...
// This is the only function exposed by evmwrap, which is called in Golang.
// In this function, the mentioned go-exported function pointers are passed to C environment for callback
